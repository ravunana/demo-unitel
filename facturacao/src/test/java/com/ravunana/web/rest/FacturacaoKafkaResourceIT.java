...
public class FacturacaoKafkaResourceIT {
    ...
    @Autowired
    private FacturacaoKafkaProducer producer;

    @Autowired
    private FacturacaoKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        FacturacaoKafkaResource kafkaResource = new FacturacaoKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/facturacao-kafka/publish?message=test"))
