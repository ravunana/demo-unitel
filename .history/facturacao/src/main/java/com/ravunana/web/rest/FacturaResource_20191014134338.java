...
public class FacturaResource {
    ...
    public ResponseEntity<FacturaDTO> createFactura(@Valid @RequestBody FacturaDTO facturaDTO) throws URISyntaxException {
        ...
        Per jsonObject = gson.fromJson( json, JsonObject.class);
        String qtdeString = jsonObject.get("produtoNome");
        String codigoString = jsonObject.get("produtoNome");

        Integer quantidade = Integer.valueOf( qtdeString );
        Integer codigo = Integer.valueOf( codigoString );

        log.info("sended factura oject to topic_estoque Quantidade; {} - ID: {} ", quantidade, codigo );
