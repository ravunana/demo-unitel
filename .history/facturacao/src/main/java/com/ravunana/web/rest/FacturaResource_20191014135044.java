...
public class FacturaResource {
    ...
    public ResponseEntity<FacturaDTO> createFactura(@Valid @RequestBody FacturaDTO facturaDTO) throws URISyntaxException {
        ...
        FacturaDTO jsonObject = gson.fromJson( json, FacturaDTO.class);



        log.info("sended factura oject to topic_estoque Quantidade; {} - ID: {} ", jsonObject.getProdutoQuantidade, jsonObject.getProdutoCodigo );
