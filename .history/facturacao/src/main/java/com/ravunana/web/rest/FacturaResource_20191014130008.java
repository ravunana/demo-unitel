...
public class FacturaResource {
    ...
    public ResponseEntity<FacturaDTO> createFactura(@Valid @RequestBody FacturaDTO facturaDTO) throws URISyntaxException {
        ...
        int quantidade = jsonObject.get("produtoNome");

        log.info("sended factura oject to topic_estoque Quantidade; {} - ID: {} ", jsonObject.get("produtoNome"), Integer.valueOf(jsonObject.get("produtoCodigo")) );
