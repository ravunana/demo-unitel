...
public class EstoqueKafkaResourceIT {
    ...
    @Autowired
    private EstoqueKafkaProducer producer;

    @Autowired
    private EstoqueKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        EstoqueKafkaResource kafkaResource = new EstoqueKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/estoque-kafka/publish?message=test"))
