...
import com.ravunana.service.UaaKafkaProducer;
import com.ravunana.service.UaaKafkaConsumer;
...
public class UaaKafkaResourceIT {
    ...
    @Autowired
    private UaaKafkaProducer producer;

    @Autowired
    private UaaKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        UaaKafkaResource kafkaResource = new UaaKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/uaa-kafka/publish?message=test"))
