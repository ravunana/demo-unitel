...
import com.ravunana.GatewayApp;
import com.ravunana.config.SecurityBeanOverrideConfiguration;
import com.ravunana.service.GatewayKafkaProducer;
import com.ravunana.service.GatewayKafkaConsumer;
...
public class GatewayKafkaResourceIT {
    ...
    @Autowired
    private GatewayKafkaProducer producer;

    @Autowired
    private GatewayKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        GatewayKafkaResource kafkaResource = new GatewayKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/gateway-kafka/publish?message=test"))
